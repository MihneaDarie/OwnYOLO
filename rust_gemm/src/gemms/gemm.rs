...
use crate::gemms::mm512_gemm::gemm_bias_blocked_avx512;
use crate::{
    activations::Activation, gemms::{
        appcontext::{Device, GemmType, get_global_context}, mm256_gemm::{add_avx2, apply_sigmoid_avx2_from_src, apply_silu_avx2_from_src, div_avx2, gemm_bias_blocked_avx2, mul_avx2, sub_avx2}, mm512_gemm::{add_avx512, apply_sigmoid_avx512_from_src, apply_silu_avx512_from_src, div_avx512, gemm_bias_blocked_scalar, mul_avx512, sub_avx512}, utils::{aprox_sigmoid_f32, aprox_silu_f32}
    }
};
